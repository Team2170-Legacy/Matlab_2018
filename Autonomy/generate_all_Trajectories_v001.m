...
for traj = 1:length(all_Trajectories)
    ...
    if make_movies
        ...
        movie_file_name = [ 'Robot_Movie_' all_Trajectories_String(trajString) '.mp4' ];
        make_dot_h_file_v001(trajectory,all_omega_R,all_omega_L,all_t,Robot,t_auto_end, i_auto_end);
