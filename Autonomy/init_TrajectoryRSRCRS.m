...
RSRCRS.x = [Field.RSRC.x, Field.RSRC.x + Robot.L/2, (Field.RSwitch.RightP.tr_x + Field.RSwitch.RightP.tl_x)/2 + RSRCRS.add_x, (Field.RSwitch.RightP.tr_x + Field.RSwitch.RightP.tl_x)/2 + RSRCRS.add_x];
RSRCRS.y = [Field.RSRC.y, Field.RSRC.y, Field.RSRC.y-.35, Field.RSwitch.RightP.br_y-Robot.L/2 + RSRCRS.add_y];
